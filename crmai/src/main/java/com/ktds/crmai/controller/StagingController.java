...
public class StagingController {
    ...
    public ResponseEntity<Object> getTrain(@ModelAttribute("staingTrain") AI_STAGING staingTrain){
    	logger.info("Request List....getTrain.... - {} {} {} {}", staingTrain.getCam_id(), staingTrain.getPage(), staingTrain.getPage_st(), staingTrain.getPage_end());
    	List<AI_STAGING> trainData = null;
    	
    	if(staingTrain.getCam_id() != null) {
    		trainData = staginService.selectStaginTrain(staingTrain);
    	}
...
//    	}
    ...
    public ResponseEntity<Object> getTrainResult(@ModelAttribute("staingTrainResult") AI_STAGING staingTrainResult){
