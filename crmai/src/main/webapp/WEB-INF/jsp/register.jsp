...
<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">AI CAP 회원가입</p>
     ...
     <div class="form-group has-feedback">
       <input id="ADM_NAME" name="ADM_NAME" type="text" class="form-control" placeholder="이름">
       <span class="glyphicon glyphicon-user form-control-feedback"></span>
     </div>

     <div class="form-group has-feedback">
       <input id="ADM_EMAIL" name="ADM_EMAIL" type="email" class="form-control" placeholder="E-mail">
     ...
     <div class="form-group has-feedback">
       <input id="ADM_PW_R" name="ADM_PW_R" type="password" class="form-control" placeholder="비밀번호 확인">
     ...
     <div class="row">
       ...
       <!-- /.col -->
       <div class="col-xs-4">
         <button onclick="register_check();" class="btn btn-primary btn-block btn-flat">회원가입</button>
       </div>
       <!-- /.col -->
     </div>
