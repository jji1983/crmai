			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
							<span>AI 캠페인 대상자 학습</span> <span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a
								href="javascript:Content_Pretreatment();"><i
									class="fa fa-circle-o"></i>대상자 로딩</a></li>
						</ul></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-laptop"></i>
						...
						<ul class="treeview-menu">
							<li class="active"><a
								href="javascript:Content_RunForecast();"><i
									class="fa fa-circle-o"></i>AI 대상자 로딩</a></li>
						</ul></li>

					<li class="header">부가 기능</li>
					<li><a href="javascript:Content_RunForecastResult();"><i
							class="fa fa-circle-o text-aqua"></i> <span>AI 선정결과</span></a></li>

					<li class="treeview"><a href="#"> <i
							class="fa fa-pie-chart"></i> <span>통계</span> <span
						...
						<ul class="treeview-menu">
							<li class="active"><a
								href="javascript:Content_Statistics_m1();"><i
									class="fa fa-circle-o"></i>선정대상에 대한 실질반응1</a></li>
							<li class="active"><a
								href="javascript:Content_Statistics_m2();"><i
									class="fa fa-circle-o"></i>선정대상에 대한 실질반응2</a></li>
							<li class="active"><a
								href="javascript:Content_Statistics_m3();"><i
									class="fa fa-circle-o"></i>선정대상에 대한 실질반응3</a></li>
						</ul></li>
 ...
 %></li>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<iframe id="main_frame" src="/iframe/Dashboard" width="100%"
					height="80%"></iframe>
			</section>
			<!-- /.Main content -->
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2018 <a href="http://www.ktds.com">CRM운영팀
					AI학습체</a>.
