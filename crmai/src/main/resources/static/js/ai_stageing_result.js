...
function grid_pagingSt3(div){
	...
	window.pagObj = div.twbsPagination({
          ...
          onPageClick: function (event, page) {
        	  ...
        	  s3_page_st = ((1 * s3_visiblePages) * page) - (s3_visiblePages - 1);
        	  s3_page_end = (s3_page_st + s3_visiblePages) - 1;
...
function grid_tableStaging3(obj){
	//alert("grid_table_campaign :: " + obj);
	var div = document.querySelector('#ai_staging_result');
